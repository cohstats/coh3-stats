  ...
  const chartData = [
    {
      ...
      value: axisPlayers.reduce((acc, cur) => acc + cur.counters.vkill, 0),
    ...
    },
    {
      ...
      label: "Allies",
      short: "Allies",
      value: alliesPlayers.reduce((acc, cur) => acc + cur.counters.vkill, 0),
...
export default VehiclesKilledPieChart;
