  ...
  const chartData = [
    {
      ...
      value: axisPlayers.reduce((acc, cur) => acc + cur.counters.ekills, 0),
    ...
    },
    {
      ...
      label: "Allies",
      short: "Allies",
      value: alliesPlayers.reduce((acc, cur) => acc + cur.counters.ekills, 0),
...
export default UnitsKilledPieChart;
