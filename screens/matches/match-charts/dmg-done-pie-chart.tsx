  ...
  const chartData = [
    {
      ...
      value: axisPlayers.reduce((acc, cur) => acc + cur.counters.dmgdone, 0),
    ...
    },
    {
      ...
      label: "Allies",
      short: "Allies",
      value: alliesPlayers.reduce((acc, cur) => acc + cur.counters.dmgdone, 0),
...
export default DmgDonePieChart;
