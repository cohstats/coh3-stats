...
import { calculateWinRate, convertWeekDayToFullName } from "../../../../src/utils";

const ActivityByWeekDay = ({ playerStatsData }: { playerStatsData: ProcessedCOHPlayerStats }) => {
...
export default ActivityByWeekDay;
