...
const defaultStatsPatchSelector = "2.5.0";
...
const patches: Record<string, { dataTag: string; dataTime: string; patchTimeSeconds?: number }> =
  {
    ...
    "2.4.1": {
      dataTag: "v2.4.1-1",
      dataTime: "22/May/2026",
    },
    "2.4.0": {
      dataTag: "v2.4.0-1",
      dataTime: "14/May/2026",
    },
    "2.3.1": {
      dataTag: "v2.3.1-1",
    ...
    "2.2.3": {
      dataTag: "v2.2.3-1",
      dataTime: "16/Dec/2025",
    },
    "2.2.2": {
      dataTag: "v2.2.2-1",
      dataTime: "09/Dec/2025",
    },
    "2.2.1": {
      dataTag: "v2.2.1-1",
      dataTime: "02/Dec/2025",
    },
    "2.2.0": {
      dataTag: "v2.2.0-1",
    ...
    "2.1.2": {
      dataTag: "v2.1.2-1",
      dataTime: "16/July/2025",
    },
    "2.1.1": {
      dataTag: "v2.1.1-1",
      dataTime: "27/June/2025",
    },
    "2.1.0": {
      dataTag: "v2.1.0-1",
      dataTime: "25/June/2025",
    },
    "2.0.5": {
      dataTag: "v2.0.5-2",
    ...
    "2.0.2": {
      dataTag: "v2.0.2-1",
      dataTime: "04/March/2025",
    },
    "2.0.1": {
      dataTag: "v2.0.1-1",
      dataTime: "26/Feb/2025",
    },
    "2.0.0": {
      dataTag: "v2.0.0-1",
      dataTime: "25/Feb/2025",
    },
    "1.9.4": {
      dataTag: "v1.9.4-1",
      dataTime: "13/Dec/2024",
    },
    "1.9.3": {
      dataTag: "v1.9.2-1",
...
const config = {
  ...
  FULL_BUILD: process.env.FULL_BUILD === "true" || false,
};
